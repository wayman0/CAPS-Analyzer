...
class fileManager {
  ...
  public:
    ...
    void         observatory(OBSERVATORY obs){m_observatory = obs;}
    ...
    int          min_energy(float E, int garbage);
    int          max_energy(float E, int garbage);
    ...
    virtual baseData        *getVectorI()  = 0;
    virtual baseData        *getVectorD()  = 0;
    virtual baseData        *getMatrixD()  = 0;
    virtual baseData        *getCubeCD()   = 0;
    virtual dataMap         *getMap()      = 0;
    virtual dataSpectrum    *getSpectrum() = 0;
    ...
    virtual bool            saveVectorI(vectorData<int> *vd)           = 0;
    virtual bool            saveVectorD(vectorData<double> *vd)        = 0;
    virtual bool            saveMatrixD(matrixData<double> *md)        = 0;
    virtual bool            saveCubeCD(cubeData<complex<double> > *cd) = 0;
    virtual bool            saveMap(dataMap *map)                      = 0;
    virtual bool            saveSpectrum(dataSpectrum *spect)          = 0;
