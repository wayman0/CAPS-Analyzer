...
Pixelizer::Pixelizer(Pixelizer* from) {
  ...
  m_usePixAvg  = from->usePixelAvg();
  m_usePixDev  = from->usePixelDev();
  m_usePixVar  = from->usePixelVar();

  m_doAvgNorm  = from->doAvgNormalize();
  m_doVarNorm  = from->doVarNormalize();
  m_doMinMax   = from->doMinMaxScale();
