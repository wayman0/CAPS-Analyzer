...
class controlDataDialog : public controlDataDialogParent
{
	public:
		controlDataDialog(association* assoc, std::function<void(FILETYPE, bool)> s, std::function<void()> c);
	...
	private:
		...
		std::function<void(FILETYPE, bool)> successFunc;
