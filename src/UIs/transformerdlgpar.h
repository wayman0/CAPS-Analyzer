 ...
 ***************************************************************************/
#ifndef _TRANSFORMERDIALOGPARENT_H_
#define _TRANSFORMERDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class transformerDialogParent
{
  public:

	transformerDialogParent(association *assoc);
    virtual ~transformerDialogParent() {};
  ...
  //Q_SIGNALS:
    virtual void transformerSelected(TRANSFORMERSCHEME) = 0;
