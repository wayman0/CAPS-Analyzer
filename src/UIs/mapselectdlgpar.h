 ...
 ***************************************************************************/
#ifndef _MAPSELECTDIALOGPARENT_H_
#define _MAPSELECTDIALOGPARENT_H_
...
{
	public:
		mapSelectDialogParent(association* assoc);
		virtual ~mapSelectDialogParent();

		void setAssociation(association* newAssoc) {dataMgr = newAssoc;}

	//Q_SIGNALS:
		virtual void mapSelected(ASSOCIATEDMAP) = 0;
