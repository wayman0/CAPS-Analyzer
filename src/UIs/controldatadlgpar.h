 ...
 ***************************************************************************/
#ifndef _CONTROLDATADIALOGPARENT_H_
#define _CONTROLDATADIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class controlDataDialogParent
{
  public:
    controlDataDialogParent(association* assoc);
    virtual ~controlDataDialogParent() {}
  ...
  //Q_SIGNALS:
    ...
    virtual void buildControlData(FILETYPE,bool) = 0;
  ...
  // Q_SLOTS:
    ...
    //virtual void addData(QAbstractButton* button) = 0;
    virtual void cancel() = 0;
    virtual void help() = 0;
    virtual void changeStack(int frame) = 0;
};
#endif
