 ...
 ***************************************************************************/
#ifndef _GRAPHDIALOGPARENT_H_
#define _GRAPHDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class graphDialogParent
{
	public:
		graphDialogParent(association *assoc);
		virtual ~graphDialogParent();
	...
	//Q_SIGNALS:
		virtual void grapherReady() = 0;
		virtual void grapherCancelled() = 0;
