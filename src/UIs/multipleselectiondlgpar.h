 ...
 ***************************************************************************/
#ifndef _MULTIPLESELECTIONDIALOGPARENT_H_
#define _MULTIPLESELECTIONDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class multipleSelectionDialogParent
{
  public:
  ...
  //Q_SIGNALS:
    virtual void energySelectionCancelled() = 0;
    virtual void slicesSelected(int, int) = 0;
