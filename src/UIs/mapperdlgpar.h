 ...
 * Description:                                                            *
 *                                                                         *
 * This class defines the mapper dialog box structure associated           *
 ...
 ***************************************************************************/
#ifndef _MAPPERDIALOGPARENT_H_
#define _MAPPERDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class mapperDialogParent
{
	public:
		mapperDialogParent(association *assoc);
		virtual ~mapperDialogParent();
		...
		ORIENTATION orientation() {return longConvention;}
		MAPTYPE     project()     {return projection;}
		COLORSCHEME colorScheme() {return hue;}
	...
	//Q_SIGNALS:
		virtual void mapperCancelled() = 0;
		virtual void mapperReady() = 0;
	...
	//private Q_SLOTS:
		...
		virtual void help() = 0;
		virtual void activateCustom(bool check) = 0;
