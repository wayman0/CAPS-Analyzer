 ...
 ***************************************************************************/
#ifndef _ENERGYDIALOGPARENT_H_
#define _ENERGYDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class energyDialogParent
{
  public:
    energyDialogParent();
    virtual ~energyDialogParent() {}
  ...
  //Q_SIGNALS:
    ...
    virtual void energySelected(double,double) = 0;
