 ...
 ***************************************************************************/
#ifndef _PIXELIZERDIALOGPARENT_H_
#define _PIXELIZERDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class pixelizerDialogParent
{
  public:
    pixelizerDialogParent(association* assoc);
    virtual ~pixelizerDialogParent() {};
  ...
  //Q_SIGNALS:
    virtual void pixelizerSelected(PIXELSCHEME) = 0;
