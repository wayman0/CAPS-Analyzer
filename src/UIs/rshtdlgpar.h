 ...
 ***************************************************************************/
#ifndef _RSHTDIALOGPARENT_H_
#define _RSHTDIALOGPARENT_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class rshtDialogParent
{
  public:
    rshtDialogParent(association *assoc);
    virtual ~rshtDialogParent() {}
  ...
  //Q_SIGNALS:
    virtual void transformationCancelled() = 0;
