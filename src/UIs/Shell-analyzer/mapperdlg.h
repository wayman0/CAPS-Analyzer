 ...
 ***************************************************************************/
#ifndef _MAPPERDIALOG_H_
#define _MAPPERDIALOG_H_
...
class mapperDialog : public mapperDialogParent
{
	public:
		mapperDialog(association *assoc, std::istream* i, std::ostream* o, std::function<void()> s, std::function<void()> c);
		...
		void mapperReady() {successFunc(); }
		void mapperCancelled() {cancelFunc(); }
