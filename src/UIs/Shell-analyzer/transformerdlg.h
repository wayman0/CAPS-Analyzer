...
class transformerDialog : public transformerDialogParent
{
  public:
    transformerDialog(association *assoc, std::istream* i, std::ostream* o,
					  std::function<void(TRANSFORMERSCHEME t)> s, std::function<void()> c);
    virtual ~transformerDialog();

    void transformerSelected(TRANSFORMERSCHEME t) {successFunc(t);}
  ...
  private:
	...
	std::istream* input;
	std::ostream* output;
	std::function<void(TRANSFORMERSCHEME t)> successFunc;
