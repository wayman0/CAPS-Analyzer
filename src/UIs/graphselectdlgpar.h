 ...
 ***************************************************************************/
#ifndef _GRAPHSELECTDIALOGPARENT_H_
#define _GRAPHSELECTDIALOGPARENT_H_
...
{
	public:
		graphSelectDialogParent(association* assoc);
		virtual ~graphSelectDialogParent();
		void setAssociation(association* newAssoc) {dataAssoc = newAssoc; }

	//Q_SIGNALS:
		virtual void graphSelected(ASSOCIATEDSPECTRUM) = 0;
