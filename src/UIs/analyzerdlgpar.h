 ...
 ***************************************************************************/
#ifndef _ANALYZERDIALOGPAR_H_
#define _ANALYZERDIALOGPAR_H_

#include "../libanalyzer/atypes.h"
#include "../libanalyzer/association.h"

class analyzerDialogParent
{
  public:
    analyzerDialogParent(association* assoc);
    virtual ~analyzerDialogParent() {}
    ...
    // Q_Signal
    virtual void analyzerSelected() = 0;
