 ...
 ***************************************************************************/
#ifndef _SPECTRUMDIALOGPARENT_H_
#define _SPECTRUMDIALOGPARENT_H_

class spectrumDialogParent
{
  public:
    spectrumDialogParent();
    virtual ~spectrumDialogParent() {}
  ...
  //Q_SIGNALS:
    virtual void powerSpectrumCancelled() = 0;
    virtual void spectrumReady() = 0;
